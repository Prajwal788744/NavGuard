...
import { Moon, Sun, User, LogOut, Menu, X, Globe, ChevronDown, ArrowLeft, MoreVertical, Home, MapPin, Clock, Cloud, Calendar, UserCircle } from 'lucide-react';
                  ...
                  <>
                    ...
                    >
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-semibold bg-destructive/10 text-destructive hover:bg-destructive hover:text-destructive-foreground transition-colors"
                      >
                        <LogOut size={18} />
                        {t('logout') || 'Logout'}
                      </button>
